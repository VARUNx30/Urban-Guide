    ...
    <div class="container mx-auto h-full max-w-[90%] py-20">
      ...
      >
        <admin-item
          ...
          :key="product.education_id"
          :data="product"
          :link="product.education_id"
          type="educations"
          :method="openPopup"
        />
      </div>
...
export default {
  ...
  methods: {
    ...mapActions(["fetchEducations", "deleteEducationById"]),
    ...
    async deleteProduct() {
      await this.deleteEducationById(this.deleteId);
