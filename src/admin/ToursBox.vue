  ...
  <AdminLayout class="min-h-screen bg-darkgray-900">
    <div class="container mx-auto h-full max-w-[90%] py-20">
      <div class="flex h-auto w-full items-center justify-between">
        <h1 class="text-center text-t-4 font-bold text-theme">Active Tours</h1>
...
export default {
  ...
  methods: {
    ...mapActions(["fetchTours", "deleteTourById"]),
    ...
    async deleteProduct() {
      await this.deleteTourById(this.deleteId);
